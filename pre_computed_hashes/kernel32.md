...
|------------|:-------:|:----:|-------------------------------------------------------------------------------------------        
| 0xA77D8D5A |       1 |    0 |  AcquireSRWLockExclusive (forwarded to NTDLL.RtlAcquireSRWLockExclusive)
| 0xE2385C49 |       2 |    1 |  AcquireSRWLockShared (forwarded to NTDLL.RtlAcquireSRWLockShared)
...
| 0xE3EAC3E7 |       9 |    8 |  AddDllDirectory (forwarded to api-ms-win-core-libraryloader-l1-1-0.AddDllDirectory)
...
| 0x1A945C3B |      19 |   12 |  AddVectoredContinueHandler (forwarded to NTDLL.RtlAddVectoredContinueHandler)
| 0x159B3EA0 |      20 |   13 |  AddVectoredExceptionHandler (forwarded to NTDLL.RtlAddVectoredExceptionHandler)
...
| 0xC05A4851 |      25 |   18 |  AppPolicyGetClrCompat (forwarded to kernelbase.AppPolicyGetClrCompat)
| 0x58041CEA |      26 |   19 |  AppPolicyGetCreateFileAccess (forwarded to kernelbase.AppPolicyGetCreateFileAccess)
| 0xB85D40D5 |      27 |   1A |  AppPolicyGetLifecycleManagement (forwarded to kernelbase.AppPolicyGetLifecycleManagement)
| 0xF9B135C3 |      28 |   1B |  AppPolicyGetMediaFoundationCodecLoading (forwarded to kernelbase.AppPolicyGetMediaFoundationCodecLoading)
| 0xA8B49C4E |      29 |   1C |  AppPolicyGetProcessTerminationMethod (forwarded to kernelbase.AppPolicyGetProcessTerminationMethod)
| 0xBA9CCFD9 |      30 |   1D |  AppPolicyGetShowDeveloperDiagnostic (forwarded to kernelbase.AppPolicyGetShowDeveloperDiagnostic)
| 0xFB80DF4A |      31 |   1E |  AppPolicyGetThreadInitializationType (forwarded to kernelbase.AppPolicyGetThreadInitializationType)
| 0x95860C87 |      32 |   1F |  AppPolicyGetWindowingModel (forwarded to kernelbase.AppPolicyGetWindowingModel)
| 0x4C35AC32 |      33 |   20 |  AppXGetOSMaxVersionTested (forwarded to kernelbase.AppXGetOSMaxVersionTested)
...
| 0x772B6A86 |     145 |   90 |  CloseThreadpoolTimer (forwarded to NTDLL.TpReleaseTimer)
...
| 0x62BE0696 |     293 |  124 |  DisassociateCurrentThreadFromCallback (forwarded to NTDLL.TpDisassociateCallback)
...
| 0xFC078E45 |     404 |  193 |  FindNextStreamW (forwarded to api-ms-win-core-file-l1-2-2.FindNextStreamW)
...
| 0xCDF454F3 |     737 |  2E0 |  GetSystemCpuSetInformation (forwarded to api-ms-win-core-processthreads-l1-1-3.GetSystemCpuSetInformation)
...
| 0x47AE9C64 |     885 |  374 |  InterlockedPushListSListEx (forwarded to NTDLL.RtlInterlockedPushListSListEx)
...
| 0x7DD4C357 |    1095 |  446 |  QueryDepthSList (forwarded to NTDLL.RtlQueryDepthSList)
...
| 0x84E1BC3  |   1109 |  454 |  QueryProtectedPolicy (forwarded to api-ms-win-core-processthreads-l1-1-2.QueryProtectedPolicy)
...
| 0xF6024798 |    1128 |  467 |  RaiseFailFastException (forwarded to kernelbase.RaiseFailFastException)
...
| 0xDFCAE10A |    1133 |  46C |  ReadConsoleInputExA (forwarded to kernelbase.ReadConsoleInputExA)
| 0xDFCAE120 |    1134 |  46D |  ReadConsoleInputExW (forwarded to kernelbase.ReadConsoleInputExW)
...
| 0xC54A6921 |    1149 |  47C |  ReclaimVirtualMemory (forwarded to api-ms-win-core-memory-l1-1-2.ReclaimVirtualMemory)
...
| 0x99F452D6 |    1206 |  4B5 |  ReleaseMutexWhenCallbackReturns (forwarded to NTDLL.TpCallbackReleaseMutexOnCompletion)
| 0x557E6DA6 |    1207 |  4B6 |  ReleaseSRWLockExclusive (forwarded to NTDLL.RtlReleaseSRWLockExclusive)
| 0xE2A88220 |    1208 |  4B7 |  ReleaseSRWLockShared (forwarded to NTDLL.RtlReleaseSRWLockShared)
| 0xDF11EB6D |    1209 |  4B8 |  ReleaseSemaphore
| 0x7D17646B |    1210 |  4B9 |  ReleaseSemaphoreWhenCallbackReturns (forwarded to NTDLL.TpCallbackReleaseSemaphoreOnCompletion)
...
| 0x8D507E95 |    1215 |  4BE |  RemoveDllDirectory (forwarded to api-ms-win-core-libraryloader-l1-1-0.RemoveDllDirectory)
...
| 0x8FEFAF06 |    1219 |  4C2 |  RemoveVectoredContinueHandler (forwarded to NTDLL.RtlRemoveVectoredContinueHandler)
| 0xABF6E97A |    1220 |  4C3 |  RemoveVectoredExceptionHandler (forwarded to NTDLL.RtlRemoveVectoredExceptionHandler)
...
| 0x78149E90 |    1230 |  4CD |  ResolveDelayLoadedAPI (forwarded to NTDLL.LdrResolveDelayLoadedAPI)
| 0xEBDA2C81 |    1231 |  4CE |  ResolveDelayLoadsFromDll (forwarded to NTDLL.LdrResolveDelayLoadsFromDll)
| 0x28B4A822 |    1232 |  4CF |  ResolveLocaleName
| 0x2FAB3CB4 |    1233 |  4D0 |  RestoreLastError (forwarded to NTDLL.RtlRestoreLastWin32Error)
...
| 0xC53D4FDB |    1251 |  4E2 |  RtlZeroMemory (forwarded to NTDLL.RtlZeroMemory)
...
| 0x2AD46BD2 |    1282 |  501 |  SetConsoleInputExeNameA (forwarded to kernelbase.SetConsoleInputExeNameA)
| 0x2AD46BE8 |    1283 |  502 |  SetConsoleInputExeNameW (forwarded to kernelbase.SetConsoleInputExeNameW)
...
| 0x1245F22D |    1301 |  514 |  SetCriticalSectionSpinCount (forwarded to NTDLL.RtlSetCriticalSectionSpinCount)
...
| 0x6228050D |    1307 |  51A |  SetDefaultDllDirectories (forwarded to api-ms-win-core-libraryloader-l1-1-0.SetDefaultDllDirectories)
...
| 0x6A29268F |    1318 |  525 |  SetEventWhenCallbackReturns (forwarded to NTDLL.TpCallbackSetEventOnCompletion)
...
| 0x450C1854 |    1343 |  53E |  SetLastConsoleEventActive (forwarded to kernelbase.SetLastConsoleEventActive)
...
| 0x44DB94   |  1358 |  54D |  SetProcessDefaultCpuSets (forwarded to api-ms-win-core-processthreads-l1-1-3.SetProcessDefaultCpuSets)
| 0x7424089B |    1359 |  54E |  SetProcessInformation
| 0x11179356 |    1360 |  54F |  SetProcessMitigationPolicy (forwarded to api-ms-win-core-processthreads-l1-1-1.SetProcessMitigationPolicy)
...
| 0x4B007932 |    1366 |  555 |  SetProtectedPolicy (forwarded to api-ms-win-core-processthreads-l1-1-2.SetProtectedPolicy)
...
| 0x2D28C712 |    1379 |  562 |  SetThreadDescription (forwarded to api-ms-win-core-processthreads-l1-1-3.SetThreadDescription)
...
| 0xEA7E3E12 |    1390 |  56D |  SetThreadSelectedCpuSets (forwarded to api-ms-win-core-processthreads-l1-1-3.SetThreadSelectedCpuSets)
| 0x8C915887 |    1391 |  56E |  SetThreadStackGuarantee
| 0x7F1CAE66 |    1392 |  56F |  SetThreadToken (forwarded to api-ms-win-core-processthreads-l1-1-0.SetThreadToken)
| 0x6BCE3F9  |   1393 |  570 |  SetThreadUILanguage
| 0xB48C4CF1 |    1394 |  571 |  SetThreadpoolStackInformation
| 0x2E1DC543 |    1395 |  572 |  SetThreadpoolThreadMaximum (forwarded to NTDLL.TpSetPoolMaxThreads)
| 0x2E1D2547 |    1396 |  573 |  SetThreadpoolThreadMinimum
| 0x3C1CE3A8 |    1397 |  574 |  SetThreadpoolTimer (forwarded to NTDLL.TpSetTimer)
| 0x960EA87  |   1398 |  575 |  SetThreadpoolTimerEx (forwarded to NTDLL.TpSetTimerEx)
| 0xA246C592 |    1399 |  576 |  SetThreadpoolWait (forwarded to NTDLL.TpSetWait)
| 0x93D96520 |    1400 |  577 |  SetThreadpoolWaitEx (forwarded to NTDLL.TpSetWaitEx)
...
| 0xAB506F1C |    1414 |  585 |  SetWaitableTimerEx (forwarded to api-ms-win-core-synch-l1-1-0.SetWaitableTimerEx)
...
| 0x636607EB |    1421 |  58C |  SleepConditionVariableCS (forwarded to api-ms-win-core-synch-l1-2-0.SleepConditionVariableCS)
| 0x3F531F87 |    1422 |  58D |  SleepConditionVariableSRW (forwarded to api-ms-win-core-synch-l1-2-0.SleepConditionVariableSRW)
| 0xCD7A6CAE |    1423 |  58E |  SleepEx
| 0x4866EB1B |    1424 |  58F |  SortCloseHandle
| 0xA917DB76 |    1425 |  590 |  SortGetHandle
| 0xDF3331   |  1426 |  591 |  StartThreadpoolIo (forwarded to NTDLL.TpStartAsyncIoOperation)
| 0x3FE9721A |    1427 |  592 |  SubmitThreadpoolWork (forwarded to NTDLL.TpPostWork)
...
| 0x511C19BA |    1433 |  598 |  SystemTimeToTzSpecificLocalTimeEx (forwarded to api-ms-win-core-timezone-l1-1-0.SystemTimeToTzSpecificLocalTimeEx)
...
| 0x569DFF5D |    1460 |  5B3 |  TryAcquireSRWLockExclusive (forwarded to NTDLL.RtlTryAcquireSRWLockExclusive)
| 0x72715DA1 |    1461 |  5B4 |  TryAcquireSRWLockShared (forwarded to NTDLL.RtlTryAcquireSRWLockShared)
| 0x33D51212 |    1462 |  5B5 |  TryEnterCriticalSection (forwarded to NTDLL.RtlTryEnterCriticalSection)
| 0xEE17432A |    1463 |  5B6 |  TrySubmitThreadpoolCallback
| 0x70D38544 |    1464 |  5B7 |  TzSpecificLocalTimeToSystemTime
| 0x37095194 |    1465 |  5B8 |  TzSpecificLocalTimeToSystemTimeEx (forwarded to api-ms-win-core-timezone-l1-1-0.TzSpecificLocalTimeToSystemTimeEx)
...
| 0x844C96E4 |    1473 |  5C0 |  UnmapViewOfFileEx (forwarded to api-ms-win-core-memory-l1-1-1.UnmapViewOfFileEx)
...
| 0x41E5D7CB |    1482 |  5C9 |  UpdateProcThreadAttribute (forwarded to api-ms-win-core-processthreads-l1-1-0.UpdateProcThreadAttribute)
...
| 0xB917C2E1 |    1489 |  5D0 |  VerSetConditionMask (forwarded to NTDLL.VerSetConditionMask)
...
| 0x6277ACE4 |    1508 |  5E3 |  WaitForDebugEventEx (forwarded to api-ms-win-core-debug-l1-1-2.WaitForDebugEventEx)
...
| 0xB05F0E33 |    1513 |  5E8 |  WaitForThreadpoolIoCallbacks (forwarded to NTDLL.TpWaitForIoCompletion)
| 0xA3B876D4 |    1514 |  5E9 |  WaitForThreadpoolTimerCallbacks (forwarded to NTDLL.TpWaitForTimer)
| 0xDE2810ED |    1515 |  5EA |  WaitForThreadpoolWaitCallbacks (forwarded to NTDLL.TpWaitForWait)
| 0x1E43C8F0 |    1516 |  5EB |  WaitForThreadpoolWorkCallbacks (forwarded to NTDLL.TpWaitForWork)
| 0x6415A041 |    1517 |  5EC |  WaitNamedPipeA
| 0x6415A057 |    1518 |  5ED |  WaitNamedPipeW
| 0xFE30F181 |    1519 |  5EE |  WakeAllConditionVariable (forwarded to NTDLL.RtlWakeAllConditionVariable)
| 0x12DBAFC5 |    1520 |  5EF |  WakeConditionVariable (forwarded to NTDLL.RtlWakeConditionVariable)
...
| 0xDB45D5F3 |    1587 |  632 |  __C_specific_handler (forwarded to NTDLL.__C_specific_handler)
| 0x5B22A93D |    1588 |  633 |  __chkstk (forwarded to NTDLL.__chkstk)
| 0xD99E9C43 |    1589 |  634 |  __misaligned_access (forwarded to NTDLL.__misaligned_access)
...
| 0x94CE266B |    1595 |  63A |  _local_unwind (forwarded to NTDLL._local_unwind)
